...
public class CategoriesDataSource
        extends RefreshableDataSource<Category>
{
    private AppEventBus eventBus;

    public CategoriesDataSource( AppEventBus eventBus )
    {
        this.eventBus = eventBus;
    }

    @Override
    public void load( LoadConfig<Category> loadConfig, LoadCallback<Category> callback )
    {
        super.load( loadConfig, callback );

        eventBus.paymentProcessor().getCategories(
